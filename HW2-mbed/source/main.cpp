...
#else
    static constexpr size_t REMOTE_PORT = 8000; // standard HTTP port
#endif // MBED_CONF_APP_USE_TLS_SOCKET
...
private:
    ...
    {
        // MBED_CONF_APP_HOSTNAME: "\"LAPTOP-5G1P6S5O\""
